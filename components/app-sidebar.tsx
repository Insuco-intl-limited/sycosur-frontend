      ...
      <SidebarHeader className="p-4 flex flex-row items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-dashboard-primary rounded-lg flex items-center justify-center">
            <span className="text-dashboard-primary-foreground font-bold text-sm">D</span>
          </div>
          <span className="font-semibold text-dashboard-foreground">Dashboard</span>
        </div>
      </SidebarHeader>

      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-dashboard-muted-foreground">Navigation</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map((item) => (
              ...
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton className="text-dashboard-foreground hover:bg-dashboard-accent">
                  <div className="w-6 h-6 bg-dashboard-primary rounded-full flex items-center justify-center">
                    <span className="text-xs text-dashboard-primary-foreground">U</span>
                  </div>
