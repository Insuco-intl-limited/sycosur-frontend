    ...
    extend: {
      colors: {
        ...
        dashboard: {
          ...
          "muted-foreground": "hsl(var(--dashboard-muted-foreground))",
          accent: "hsl(var(--dashboard-accent))",
          "accent-foreground": "hsl(var(--dashboard-accent-foreground))",
          border: "hsl(var(--dashboard-border))",
          sidebar: "hsl(var(--dashboard-sidebar))",
          "sidebar-background": "hsl(var(--dashboard-sidebar-background))",
